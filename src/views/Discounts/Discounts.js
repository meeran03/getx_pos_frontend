...
import { deleteDiscount, getDiscounts } from '../../Services/Discount'
import {
...
export default function TableList() {
  ...
  return (
    <GridContainer>
          ...
          <CardHeader color="primary">
            <Grid container spacing={3}>
              <Grid item xs={12} sm={12} md={10} >
                ...
                <p className={classes.cardDiscountWhite}>
                  Below, you can delete,add and list the discounts.
                </p>
              </Grid>
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        <Chip
                          ...
                          color={discount.active ? "primary" : "secondary"}
                        />
                      </TableCell>
                      <TableCell>
                          ...
                          >
                            ...
                            <DialogContent>
                              <DialogContentText id="alert-dialog-description">
                                By Agreeing, you will delete the selected Discount!
                              </DialogContentText>
                            </DialogContent>
                            <DialogActions>
                              ...
                              <Button onClick={() => handleDeletePress(discount.id)} color="primary" autoFocus>
                                Agree
                              </Button>
                            </DialogActions>
                          </Dialog>
      ...
      <AddDiscount setLoading={setLoading} setMsg={setMsg} setErr={setErr} show={showModal} handleClose={() => setShowModal(false)} />
      <UpdateDiscount setLoading={setLoading} setMsg={setMsg} setErr={setErr} show={showUpdateModal} item={selected} handleClose={() => setShowUpdateModal(false)} />
    </GridContainer>
  );
}
