...
function UpdateDiscount(props) {
  ...
  const handleSubmit = async () => {
    ...
    await updateDiscount({ name, percentage, active }, props.item.id)
      .then((res) => {
        console.log(res)
        setTC(true)
        props.setMsg('Discount Updated Successfully!')
  ...
  React.useEffect(() => {
    if (props.show) {
      ...
      setPercentage(props.item.percentage)
  ...
  return (
    ...
    >
      <div>
        <Card>
          <CardHeader>
            <Typography gutterBottom>Update Discount</Typography>
          </CardHeader>
