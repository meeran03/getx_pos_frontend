...
import { addUnit } from '../../Services/Unit'
...
function AddUnit(props) {
    ...
    const handleSubmit = async () => {
        await addUnit(name).then(res => {
            console.log(res)
            setTC(true)
            props.setMsg("Unit Added Successfully!")
    ...
    return (
        <Modal open={props.show} onClose={props.handleClose} className={classes.modal} >
            <div >
                <Card >
                    <CardHeader>
                        <Typography gutterBottom>Add A New Unit</Typography>
                    </CardHeader>

                    <CardContent>
                        <form>
                            <InputLabel style={{ color: "#AAAAAA" }}>Unit Name</InputLabel>
                            <TextField
                                value={name}
                                required
                                type="name"
                            ...
                            <br />
                            <CardFooter>
                                <Button color="primary" disableElevation variant="contained" onClick={() => handleSubmit()}>ADD UNIT</Button>
                            </CardFooter>
