...
function AddCategory(props) {
    ...
    const handleSubmit = async () => {
        await addCategory(name).then(res => {
            console.log(res)
            setTC(true)
            props.setMsg("Category Added Successfully!")
    ...
    return (
        <Modal open={props.show} onClose={props.handleClose} className={classes.modal} >
            <div >
                <Card >
                    <CardHeader>
                        <Typography gutterBottom>Add A New Category</Typography>
                    </CardHeader>

                    <CardContent>
                        <form>
                            <InputLabel style={{ color: "#AAAAAA" }}>Category Name</InputLabel>
                            <TextField
                                value={name}
                                required
                                type="name"
                            ...
                            <br />
                            <CardFooter>
                                <Button color="primary" disableElevation variant="contained" onClick={() => handleSubmit()}>ADD CATEGORY</Button>
                            </CardFooter>
