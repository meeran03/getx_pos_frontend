...
export default function TableList() {
  ...
  return (
    <GridContainer>
      ...
      >
        <Alert severity="error">{errorMsg || 'Nothing Here'}</Alert>
      </Snackbar>
          ...
          <CardHeader color="primary">
            <Grid container spacing={3}>
              <Grid item xs={12} sm={12} md={10}>
                <h4 className={classes.cardTitleWhite}>Subcategories</h4>
                <p className={classes.cardCategoryWhite}>
                  Below, you can delete,add and list the subcategories.
                </p>
              </Grid>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            By Agreeing, you will delete the selected SubCategory!
          </DialogContentText>
        </DialogContent>
        <DialogActions>
