...
import SupplierTable from "components/UserTable";
...
export default function Suppliers() {
  ...
  const handleDeletePress = () => {
    ...
    setLoading(true)
    deletesupplier(selected).then(res => {
      setOpenDelete(false);
      setType("success")
      setMsg("The Supplier was deleted Successfully!")
      setErr(true)
      setLoading(false)
    }).catch(e => {
      if (!e.response) setMsg("Network Error")
    ...
    <GridContainer>
      ...
      <GridItem xs={12} sm={12} md={12}>
        ...
        <Card>
          <CardHeader color="primary">
            <Grid container spacing={3}>
              <Grid item xs={12} sm={12} md={10} >
                <h4 className={classes.cardTitleWhite}>Getx Suppliers</h4>
                <p className={classes.cardCategoryWhite}>
                  Below, you can delete, and list the registered Suppliers.
                </p>
              </Grid>
          ...
          <CardBody>
            <SupplierTable basePath="suppliers" tableName={"Suppliers"} data={data} handleDelete={handleDelete} />
          </CardBody>
        </Card>
      </GridItem>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            By Agreeing, you will delete the selected Supplier!
          </DialogContentText>
        </DialogContent>
        <DialogActions>
