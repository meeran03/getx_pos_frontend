...
function UpdateCategory(props) {
    ...
    const handleSubmit = async () => {
        if (name !== null) {
            ...
            await updateArea(name,props.item.id).then(res => {
                console.log(res)
                setTC(true)
                props.setMsg("Area Updated Successfully!")
            ...
            <Card >
                ...
                <CardContent>
                    <form>
                        ...
                        <br/>
                        <CardFooter>
                            <Button color="primary" disableElevation variant="contained" onClick={() => handleSubmit()}>Update Area</Button>
                        </CardFooter>
