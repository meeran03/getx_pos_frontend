...
export default function Areas() {
  ...
  return (
    <GridContainer>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={12} md={10} >
                ...
                <p className={classes.cardCategoryWhite}>
                  Below, you can delete,add and list the Areas.
                </p>
            </Grid>
      ...
      <AddArea setLoading={setLoading}  setMsg={setMsg} setErr={setErr} show={showModal} handleClose={() => setShowModal(false)} />
      <UpdateArea setLoading={setLoading} setMsg={setMsg} setErr={setErr} show={showUpdateModal} item={selected} handleClose={() => setShowUpdateModal(false)} />
    ...
    >
        ...
        <DialogContentText id="alert-dialog-description">
            By Agreeing, you will delete the selected Area!
        </DialogContentText>
        </DialogContent>
        <DialogActions>
